...
it('render react node as printable data', async () => {
  ...
  expect(data).toEqual(
    new Uint8Array([
      ...
      0, 10, 27, 33, 0, 29, 33, 0, 27, 97, 0, 29, 66, 0, 67, 104, 97, 114, 103, 101, 32, 112, 114, 105, 99, 101, 58, 32,
      36, 57, 46, 57, 57, 10, 27, 33, 0, 29, 33, 0, 27, 97, 0, 29, 66, 0, 10, 27, 33, 0, 29, 33, 0, 27, 97, 0, 29, 66,
      0, 10, 10, 10, 10, 10, 10, 29, 86, 49, 27, 33, 0, 29, 33, 0, 27, 97, 0, 29, 66, 0, 27, 64,
    ])
  );
});
